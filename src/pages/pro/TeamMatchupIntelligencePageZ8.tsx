...
import { Z8_LABEL, Z8_PAGE, Z8_PANEL_PREMIUM, Z8_SECTION_HEADER, Z8_PAGE_SHELL, Z8_PAGE_PAD_X, Z8_PAGE_PAD_Y } from '../../theme/z8Tokens';
...
export default function TeamMatchupIntelligencePageZ8() {
  ...
  return (
    <main className={`${Z8_PAGE} ${Z8_PAGE_SHELL} ${Z8_PAGE_PAD_X} ${Z8_PAGE_PAD_Y}`}>
      <section className={`${Z8_PANEL_PREMIUM} relative overflow-hidden rounded-2xl p-4`}>
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div className={`min-w-0 ${Z8_SECTION_HEADER}`}>
      ...
      <section className={`${Z8_PANEL_PREMIUM} relative overflow-hidden rounded-2xl p-3 sm:p-4`}>
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div className="min-w-0">
            <div className={`ve-chip ve-chip-primary px-2.5 py-1 ${Z8_LABEL}`}>
        ...
        <div className="mt-4 flex gap-2 overflow-x-auto pb-1">
          {labelFilters.map((label) => (
            <button
              ...
              className={`shrink-0 rounded-full border px-3 py-2 ${Z8_LABEL} transition ${
                labelFilter === label
                  ? label === 'ALL'
        ...
        <div className="mt-4 overflow-hidden rounded-2xl border border-[hsl(var(--ve-border)/0.34)] bg-[hsl(var(--ve-bg-panel)/0.74)] shadow-[inset_0_1px_0_hsl(var(--ve-text-primary)/0.05)]">
          <div className="flex items-center justify-between gap-3 border-b border-[hsl(var(--ve-border)/0.28)] bg-[hsl(var(--ve-surface-raised)/0.24)] px-4 py-3">
            ...
            {data?.mode && (
              <span className={`hidden rounded-full border px-2.5 py-1 ${Z8_LABEL} sm:inline-flex ${
                data.mode === 'enriched'
          ...
          {!error && rows.length > 0 && (
            <div className="overflow-x-auto">
                    ...
                    return (
                      <tr key={rowKey} className="group transition hover:bg-[hsl(var(--ve-surface-raised)/0.22)]">
                          ...
                          >
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="mt-1 flex flex-wrap gap-1">
                                <span className={`rounded-md border border-[hsl(var(--ve-border)/0.28)] bg-[hsl(var(--ve-surface-raised)/0.34)] px-1.5 py-0.5 ${Z8_LABEL} text-[hsl(var(--ve-text-muted))]`}>
                                  {row.pitcherHand === 'U' ? 'Hand TBD' : `${row.pitcherHand}HP`}
                                </span>
                                <span className={`rounded-md border border-[hsl(var(--ve-success)/0.24)] bg-[hsl(var(--ve-success)/0.08)] px-1.5 py-0.5 ${Z8_LABEL} text-[hsl(var(--ve-success))]`}>
                        ...
                        <td className="border-b border-[hsl(var(--ve-border)/0.24)] px-3 py-3">
                          <span className={`inline-flex rounded-full border px-2 py-1 ${Z8_LABEL} ${labelClass(row.label)}`}>{row.label}</span>
                        </td>
              ...
              {(loading || enriching) && (
                <div className={`border-t border-[hsl(var(--ve-border)/0.28)] px-4 py-3 ${Z8_LABEL} text-vouch-cyan`}>
      ...
      <section className="grid gap-3 lg:grid-cols-2">
        <div className={`${Z8_PANEL_PREMIUM} relative overflow-hidden rounded-2xl p-4`}>
          <span className="absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,rgba(0,240,255,0.42),transparent)]" />
          <div className={`${Z8_LABEL} text-[hsl(var(--ve-text-primary))]`}>Scoring Model</div>
        ...
        <div className={`${Z8_PANEL_PREMIUM} relative overflow-hidden rounded-2xl p-4`}>
          ...
          <div className={`${Z8_LABEL} text-[hsl(var(--ve-text-primary))]`}>Best K Environment</div>
