...
export default function FollowingHubPage() {
  ...
  const graphEntries = useMemo(
    () => socialGraph.entries.filter((entry) => {
    ...
    [socialGraph.entries, searchQuery],
  );
      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:gap-6 space-y-4 lg:space-y-0">
        ...
        <div className="lg:w-[260px] lg:shrink-0 lg:sticky lg:top-4 lg:self-start space-y-4">
          <div className="flex items-end justify-between gap-3 lg:flex-col lg:items-start lg:justify-start lg:gap-4">
            ...
            <div className="flex rounded-full border border-white/10 bg-black/30 p-1 lg:w-full lg:flex-col lg:rounded-2xl lg:p-2 lg:gap-1">
              {(['circle', 'messages'] as const).map((tab) => (
                ...
                >
                  ...
                  {tab === 'messages' && dm.unreadCount > 0 ? (
                    <span className="ml-auto rounded-full border border-vouch-emerald/35 bg-vouch-emerald/15 px-1.5 py-0.5 text-[10px] leading-none text-vouch-emerald">
                      {dm.unreadCount}
                    </span>
                  ) : null}
                </button>
            ...
            <div className="hidden lg:flex flex-col space-y-4">
              ...
              <div className={`${Z8_PANEL_PREMIUM} p-4 space-y-2`}>
                ...
                {([
                  ...
                  ['followers', 'Followers', socialGraph.summary.followers],
                  ['friends', 'Friends', socialGraph.summary.friends],
                  ['subscribers', 'Subscribers', socialGraph.summary.subscribers],
                  ['tailing', 'Tailing', socialGraph.summary.tailing],
        ...
        <div className="flex-1 min-w-0">
          {activeTab === 'circle' ? (
            <div className="flex flex-col xl:flex-row xl:items-start xl:gap-6 space-y-4 xl:space-y-0">
                          ...
                          <div className="flex items-start gap-3">
                            <div className="relative shrink-0">
                              ...
                              {onlineUserIds.has(suggestion.profileId) ? (
                                <span className="absolute -bottom-0.5 -right-0.5 h-3.5 w-3.5 rounded-full border-2 border-transparent bg-vouch-emerald" />
                              ) : null}
                            </div>
