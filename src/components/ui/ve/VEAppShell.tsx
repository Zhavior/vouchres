      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-64 shrink-0 border-r border-white/10 bg-black/25 p-5 lg:block">
          <div className="mb-8 text-2xl font-black italic">
            Vouch<span className="text-emerald-300">Edge</span>
          </div>
        ...
        <section className="min-w-0 flex-1">
          <header className="sticky top-0 z-40 border-b border-white/10 bg-ve-obsidian/80 backdrop-blur-xl">
            <div className="flex items-center justify-between px-5 py-4">
              ...
              <div className="hidden text-xs font-black uppercase tracking-[0.3em] text-emerald-300 lg:block">
                Edge Island OS
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="rounded-full border border-emerald-300/30 px-4 py-2 text-xs font-black uppercase tracking-widest text-emerald-300"
                >
                  Profile
                </button>
              </div>
