  ...
  return (
    <div className="space-y-2.5 max-h-[290px] overflow-y-auto pr-1" id="dynamic-parlay-legs-scroller">
      {legs.map((leg, idx) => {
        ...
        return (
          <div key={idx} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-slate-950/65 p-3.5 space-y-3 shadow-lg shadow-black/20 transition-all hover:-translate-y-0.5 hover:border-emerald-300/25 hover:bg-slate-950/85">
            ...
            <div className="relative flex gap-3 items-center">
              <div className="relative flex-shrink-0">
                {playerObj?.headshot ? (
                  <img
                    ...
                    alt={leg.playerName}
                    className="h-11 w-11 rounded-2xl border border-emerald-300/20 bg-slate-950 object-cover shadow-md shadow-emerald-950/25"
                    referrerPolicy="no-referrer"
                    loading="lazy"
                    decoding="async"
                  />
                ) : (
                  <div className="grid h-11 w-11 place-items-center rounded-2xl border border-emerald-300/20 bg-emerald-400/10 text-xs font-black text-emerald-200">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex justify-between gap-2 items-start">
                  ...
                  <span className="shrink-0 rounded-full border border-emerald-300/20 bg-emerald-400/10 px-2 py-0.5 text-[10px] font-mono text-emerald-200 font-black">
            ...
            {leg.researchProfile && (
              <div className="rounded-2xl border border-emerald-300/10 bg-emerald-400/[0.035] p-3">
