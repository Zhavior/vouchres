...
const TODAY_TOOLS: DashboardCard[] = [
  ...
  },
  {
    ...
    title: 'Parlay OS',
    eyebrow: 'Track',
    description: 'Build through the global slip and track every saved parlay in one ledger.',
    accent: 'cyan',
  },
];
          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1.25fr)_minmax(320px,0.75fr)] lg:items-stretch">
            <div className="flex flex-col justify-between gap-5">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                ...
                <CommandButton label="Open Parlay OS" section="live_parlays" onSectionChange={onSectionChange} />
              </div>
            </div>
