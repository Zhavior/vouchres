...
import { DATA_LAYERS } from '../../lib/methodology-data';
          ...
          <div className="lg:col-span-5 sticky top-40">
            ...
            >
              ...
              <h2 className="text-5xl md:text-7xl font-bold tracking-tighter italic text-white leading-[0.9]">
                1.2 Million <br />
                <span className="text-white/20">Data Points.</span> <br />
                Zero Guesses.
              </h2>
              <p className="text-xl text-white/55 font-light leading-relaxed pt-6">
                ...
                We process the entire Statcast stack for every pitch, filtering for 
                measurable inefficiencies before a single hypothesis is generated.
              </p>
            ...
            {DATA_LAYERS.map((layer, i) => (
              ...
              >
                <div className="flex flex-wrap justify-between items-start gap-3 mb-4">
                  ...
                  <div className="flex shrink-0 items-center gap-2 px-2 py-1 rounded bg-ve-emerald/5 border border-ve-emerald/20">
                    <CheckCircle2 size={10} className="text-ve-emerald" />
                    <span className="text-[8px] font-bold text-ve-emerald uppercase tracking-widest">{layer.status}</span>
                  </div>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-center">
                  <div className="md:col-span-1">
                    <span className="terminal-text block mb-1">Data_Volume</span>
                    <span className="text-2xl font-mono text-white">{layer.count}</span>
                  </div>
