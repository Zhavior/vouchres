  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 text-center">
        ...
        >
          <p className="text-[11px] font-bold uppercase tracking-[0.24em] text-cyan-300/90">
            Next step
          </p>
        ...
        >
          <button
            type="button"
            onClick={onJoinBeta}
            className="group inline-flex min-h-14 w-full items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-cyan-300 to-emerald-300 px-7 text-base font-black text-[#03131a] shadow-[0_0_36px_-8px_rgba(34,211,238,0.6)] transition hover:brightness-110 sm:w-auto"
          >
            Open today&apos;s MLB research board
            <ArrowRight
              aria-hidden="true"
          ...
          <button
            type="button"
            onClick={onViewDemo}
            className="min-h-14 w-full rounded-2xl border border-white/15 px-7 text-base font-semibold text-white/85 transition hover:border-cyan-300/45 hover:bg-white/[0.05] hover:text-white sm:w-auto"
          >
