...
import { AURORA_OVERLAY_SCRIM } from '../../theme/auroraTokens';
...
export function PersonalizedOnboarding({ onComplete }: Props) {
  ...
  return (
    <main className={`fixed inset-0 z-[100] flex items-center justify-center px-4 py-10 text-white overflow-y-auto ${AURORA_OVERLAY_SCRIM}`}>
