  ...
  return (
    <>
      ...
      {isOpen ? (
        <div
          className={[
            'world-chat-aurora-max pointer-events-auto fixed z-[91] overflow-hidden border',
      ...
      >
        <button
          ...
          className={`flex h-12 w-12 items-center justify-center rounded-full border border-ve-charged shadow-ve-glow-cyan transition-all hover:scale-105 active:scale-95 sm:h-14 sm:w-14 ${
            isOpen ? 'hidden bg-[#07110f]/90 text-white md:flex' : 'flex border-emerald-400/40 bg-emerald-400/15 font-bold text-emerald-200'
          }`}
        >
          {isOpen ? (
