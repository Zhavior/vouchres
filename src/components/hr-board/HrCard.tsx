...
/** The premium, trading-terminal card used at every level of the HR
 *  Watch hierarchy — cross-game tier leaderboard and the per-game
 *  Game → Tier → Cards view both render the same card. */
const HrCard: React.FC<{ row: HrBoardRow; onSelect: () => void; onAddLeg?: OnAddLeg }> = ({ row, onSelect, onAddLeg }) => {
