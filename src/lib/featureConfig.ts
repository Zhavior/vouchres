...
export const ALL_FEATURES: FeatureConfig[] = [
  ...
  { id: "vouchscan", label: "VouchScan", icon: "ScanLine", enabled: true, order: 10 },
  { id: "research", label: "Player Research", icon: "Search", enabled: true, order: 11 },
  { id: "board", label: "Vouch Board", icon: "ClipboardCheck", enabled: true, order: 12 },
  { id: "results", label: "Results", icon: "BarChart3", enabled: true, order: 13 },
  { id: "premium", label: "PRO Premium Tiers", icon: "Sparkles", enabled: true, order: 14 },
  { id: "subscriber_hub", label: "Subscriber Clubs", icon: "MessageSquare", enabled: true, order: 15 },
  { id: "themestore", label: "Theme Store", icon: "ShoppingBag", enabled: true, order: 16, access: "admin_dev" },
  { id: "epic_themes", label: "Epic Themes", icon: "Sparkles", enabled: true, order: 17 },
  { id: "profile", label: "Profile", icon: "User", enabled: true, order: 18, locked: true },
  { id: "settings", label: "Settings", icon: "Settings", enabled: true, order: 19, locked: true },
];
