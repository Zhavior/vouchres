...
export const ALL_FEATURES: FeatureConfig[] = [
  ...
  { id: "hr_board", label: "Home Run Picks", icon: "Flame", enabled: true, order: 3, group: "Daily", sports: ALL_SPORTS, locked: true },
  ...
  { id: "messages", label: "Messages", icon: "MessageSquare", enabled: true, order: 15.6, group: "Social", locked: true },
