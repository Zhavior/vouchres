...
export const StatLeaderboardTable: React.FC<Props> = ({
  ...
  return (
    <div className="ve-stat-table-wrap overflow-x-auto rounded-xl border border-white/10 bg-[var(--ve-stat-panel)]">
      <table className="w-full min-w-[640px] border-collapse text-left">
        <thead>
          <tr className="border-b border-white/10 bg-[var(--ve-stat-panel-raised)]">
