...
export const HrBoard = ({ buckets, onSelectPlayer, onViewProfile }: HrBoardProps) => {
  return (
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4 xl:h-[calc(100vh-220px)]">
      <HrColumn 
        ...
        players={buckets.Elite} onSelect={onSelectPlayer} onViewProfile={onViewProfile}
      />
      <HrColumn 
        title="Strong" icon="🟢" colorClass="text-emerald-400" borderClass="border-emerald-500/20" 
        players={buckets.Strong} onSelect={onSelectPlayer} onViewProfile={onViewProfile}
      />
      <HrColumn 
        title="Watch" icon="🔵" colorClass="text-blue-400" borderClass="border-blue-500/20" 
        players={buckets.Watch} onSelect={onSelectPlayer} onViewProfile={onViewProfile}
      />
      <HrColumn 
        title="Sleepers" icon="🟣" colorClass="text-purple-400" borderClass="border-purple-500/20" 
        players={buckets.Sleepers} onSelect={onSelectPlayer} onViewProfile={onViewProfile}
      />
    </div>
  );
};
