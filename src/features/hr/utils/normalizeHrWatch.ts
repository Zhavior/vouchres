...
function normalizeRows(rows: readonly UnknownRecord[], mode: HrWatchMode): HrWatchRow[] {
  ...
  for (const row of rows) {
    ...
    normalized.push({
      ...
      barrelRate: firstNullableNumber(row, [
        'barrelRate',
        'barrelPct',
        'barrel_rate',
        'barrelPercentage',
      ...
      hrProbability: firstNullableNumber(row, ['hrProbability', 'estimatedHrProbability', 'estimatedHrProb', 'probability']),
