  ...
  return (
    ...
    >
      ...
      <div className="aurora-hq__factors">
        <FactorBar label="Power"   score={row.hitterPower} />
        <FactorBar label="Pitcher" score={row.pitcherVulnerability} />
        <FactorBar label="Park"    score={row.park} />
      </div>
