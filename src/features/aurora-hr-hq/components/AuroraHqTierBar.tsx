import type { DeskDisplayTier } from '../../hr-max/mapHrWatchToDesk';

const DESK_TIERS: DeskDisplayTier[] = ['Elite', 'Strong', 'Watch', 'Sleepers'];

const TIER_META: Record<DeskDisplayTier, { index: string; detail: string }> = {
...
type Props = {
  counts: Record<DeskDisplayTier, number>;
  selected: string[];
  onToggle: (tier: DeskDisplayTier) => void;
};
