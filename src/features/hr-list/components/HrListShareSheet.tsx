...
export function HrListShareSheet({ bundle, listTitle, onClose }: HrListShareSheetProps) {
  ...
  return (
    ...
    >
      <div className="flex max-h-[92vh] w-full max-w-lg flex-col overflow-y-auto border border-ve-cyan/25 bg-[#0a0a0a]">
        <header className="flex items-start justify-between gap-4 border-b border-white/10 px-5 py-4">
          <div className="min-w-0">
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-ve-emerald">
              List published
            </p>
          ...
          <button
            ...
            className="-m-2 flex h-11 w-11 items-center justify-center text-white/50 transition-colors hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-ve-cyan"
          >
        ...
        <div className="space-y-4 px-5 py-4">
          ...
          <figure className="m-0">
            {cardFailed ? (
              <div className="flex aspect-[1200/630] items-center justify-center border border-white/10 bg-white/[0.04] px-6 text-center text-xs text-white/45">
              ...
              <img
                ...
                width={1200}
                height={630}
                className="w-full border border-ve-cyan/20"
          ...
          <section>
            ...
            <textarea
              ...
              value={bundle.text}
              rows={6}
              className="mt-1.5 w-full resize-none border border-white/10 bg-white/[0.04] px-3 py-2.5 font-mono text-xs leading-relaxed text-white/85 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ve-cyan"
            />
            <button
              type="button"
              onClick={() => copy('text', bundle.text)}
              className="mt-2 inline-flex min-h-11 items-center gap-2 border border-white/10 px-3 text-xs font-semibold text-white/70 transition-colors hover:border-ve-cyan/40 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-ve-cyan"
            >
              {copied === 'text'
                ? <><Check className="h-3.5 w-3.5 text-ve-emerald" aria-hidden="true" /> Copied</>
          ...
          <section>
            ...
            <div className="mt-1.5 flex items-center gap-2 border border-white/10 bg-white/[0.04] px-3 py-2.5">
              <Link2 className="h-4 w-4 shrink-0 text-ve-cyan" aria-hidden="true" />
              <input
                readOnly
                value={bundle.permalink}
                aria-label="Shareable link"
                className="min-w-0 flex-1 bg-transparent font-mono text-xs text-ve-cyan focus-visible:outline-none"
              ...
              <button
                ...
                className="-m-1.5 flex h-11 w-11 shrink-0 items-center justify-center text-white/55 transition-colors hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-ve-cyan"
              >
                {copied === 'link'
                  ? <Check className="h-4 w-4 text-ve-emerald" aria-hidden="true" />
          ...
          <section className="space-y-2">
            ...
            <a
              ...
              className="flex min-h-12 w-full items-center justify-center gap-2 bg-white px-4 text-sm font-bold text-white/[0.02] transition-opacity hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ve-cyan"
            >
            ...
            <div className="grid grid-cols-3 gap-2 pt-1">
              {TARGETS.slice(1).map((target) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex min-h-11 items-center justify-center border border-white/10 px-2 text-xs font-semibold text-white/70 transition-colors hover:border-ve-cyan/40 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-ve-cyan"
                >
                  {target.label}
                </a>
              ))}
            ...
            {typeof navigator !== 'undefined' && 'share' in navigator && (
              <button
                type="button"
                onClick={nativeShare}
                className="flex min-h-11 w-full items-center justify-center gap-2 border border-white/10 text-xs font-semibold text-white/70 transition-colors hover:border-ve-cyan/40 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-ve-cyan"
              >
