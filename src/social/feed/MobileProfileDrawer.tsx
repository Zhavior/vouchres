                    ...
                    {drawerFeatures.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {item.id === 'hr_aurora_max' && (
                            <span className="shrink-0 rounded-full bg-vouch-cyan/15 px-1.5 py-0.5 text-[9px] font-black uppercase tracking-[0.12em] text-vouch-cyan">New</span>
                          )}
