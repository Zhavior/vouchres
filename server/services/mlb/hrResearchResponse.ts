  ...
  const response: HrResearchResponse = {
    ...
    charts: {
      ...
      pitchArsenal: research.pitchMix.map((pitch) => ({
        ...
        pitcherUsage: pitch.pitchUsage ?? null,
        batterAverage: null,
        batterSlugging: null,
        batterExpectedSlugging: pitch.xwoba ?? null,
        batterWhiffRate: pitch.whiffPct ?? null,
        runValue: null,
        matchupScore: pitch.xwoba != null ? Math.round(pitch.xwoba * 1000) : null,
        sampleSize: pitch.pitches ?? null,
      })),
