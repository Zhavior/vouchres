...
export function mountParlaySupportRoutes(router: Router): Router {
  router.post(
    "/parlays/ai-generate",
    requireAuth,
    generationLimiter,
  ...
  router.get("/me/ledger", requireAuth, asyncHandler(async (req: AuthedRequest & RequestWithContext, res: Response) => {
