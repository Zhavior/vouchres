const TODAY_URL = "https://vouchedge.xyz/api/mlb/hr-board/today?previewLimit=50";
const DEFAULT_PRO_V2_URL = "https://vouchedge.xyz/api/mlb/hr-board/pro-v2?previewLimit=50";
