...
create table public.profiles (
  ...
  capper_settings jsonb not null default '{}'::jsonb,
...
-- =========================================================
-- creator business OS (Whop-style foundation for creator operations)
-- =========================================================
create table public.creator_businesses (
  id                uuid primary key default gen_random_uuid(),
...
create index creator_businesses_owner_idx on public.creator_businesses(owner_profile_id);

create table public.creator_business_products (
  id                uuid primary key default gen_random_uuid(),
...
create index creator_business_products_business_idx on public.creator_business_products(business_id, sort_order);

create table public.creator_business_apps (
  id                uuid primary key default gen_random_uuid(),
  business_id       uuid not null references public.creator_businesses(id) on delete cascade,
...
create index creator_business_apps_business_idx on public.creator_business_apps(business_id);

create table public.creator_business_memberships (
  id                uuid primary key default gen_random_uuid(),
  business_id       uuid not null references public.creator_businesses(id) on delete cascade,
  profile_id        uuid not null references public.profiles(id) on delete cascade,
...
create index creator_business_memberships_business_idx on public.creator_business_memberships(business_id, status);
create index creator_business_memberships_profile_idx on public.creator_business_memberships(profile_id, status);

create table public.creator_business_team_members (
  id                uuid primary key default gen_random_uuid(),
  business_id       uuid not null references public.creator_businesses(id) on delete cascade,
  profile_id        uuid not null references public.profiles(id) on delete cascade,
  role              text not null,
...
create index creator_business_team_members_business_idx on public.creator_business_team_members(business_id);
